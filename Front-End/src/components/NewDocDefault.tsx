...
function NewDocDefault({ handleShowAddNewDocComponent }) {
  return (
    <Tab.Panel className="w-3/5 m-auto h-[60vh] flex flex-col bg-[#fff] rounded-[6px] shads">
      ...
      <p className="w-3/5 m-auto text-[#828282] text-[18px] font-normal text-center">
        Add a new doctor to the portal; doctors will be able to perform their
        activities with their login.
      </p>

      <div
        className="flex w-[346px] py-[16px] px-[64px] justify-center items-center gap-[10px] border border-[#0693F1] rounded-[6px] m-auto my-10 cursor-pointer"
        onClick={handleShowAddNewDocComponent}
      >
        <img src={add} alt="" />
